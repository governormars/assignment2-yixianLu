...
SVC_NAME="actions.runner.UAlberta-CMPUT401-assignment2-yixianLu.cmput401-assignmen.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (UAlberta-CMPUT401-assignment2-yixianLu.cmput401-assignment2_yxl)"
